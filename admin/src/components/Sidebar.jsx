  ...
  return (
    <div className='w-[18%] min-h-screen border-r-2'>
      <div className='flex flex-col gap-4 pt-6 pl-[20%] text-[15px]'>
        ...
        <NavLink to="/list" className='flex items-center gap-3 border border-gray-300 border-r-0 p-2'>
          <img className='w-5 h-5' src={assets.order_icon} alt="List Items" />
          <p className='hidden md:block'>List Items</p>
        </NavLink>

        <NavLink to="/orders" className='flex items-center gap-3 border border-gray-300 border-r-0 p-2'>
